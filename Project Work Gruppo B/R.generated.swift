...
struct R: Rswift.Validatable {
  ...
  struct image {
    ...
    /// Image `Topic Icon`.
    static let topicIcon = Rswift.ImageResource(bundle: R.hostingBundle, name: "Topic Icon")
    /// Image `UnCheckedList`.
    static let unCheckedList = Rswift.ImageResource(bundle: R.hostingBundle, name: "UnCheckedList")
    /// Image `UnCheckedPhoto`.
    static let unCheckedPhoto = Rswift.ImageResource(bundle: R.hostingBundle, name: "UnCheckedPhoto")
    /// Image `User Placeholder`.
    static let userPlaceholder = Rswift.ImageResource(bundle: R.hostingBundle, name: "User Placeholder")
    
    /// `UIImage(named: "Album Icon", bundle: ..., traitCollection: ...)`
    ...
    /// `UIImage(named: "Topic Icon", bundle: ..., traitCollection: ...)`
    static func topicIcon(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.topicIcon, compatibleWith: traitCollection)
    }
    
    /// `UIImage(named: "UnCheckedList", bundle: ..., traitCollection: ...)`
    static func unCheckedList(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.unCheckedList, compatibleWith: traitCollection)
    }
    
    /// `UIImage(named: "UnCheckedPhoto", bundle: ..., traitCollection: ...)`
    static func unCheckedPhoto(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.unCheckedPhoto, compatibleWith: traitCollection)
    }
  ...
  struct segue {
    ...
    struct albumListViewController {
      ...
      static let segueToAdmin: Rswift.StoryboardSegueIdentifier<UIKit.UIStoryboardSegue, AlbumListViewController, AdminPhotoCollectionViewController> = Rswift.StoryboardSegueIdentifier(identifier: "segueToAdmin")
      ...
      /// Returns nil if either the segue identifier, the source, destination, or segue types don't match.
      /// For use inside `prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?)`.
      static func segueToAdmin(segue: UIKit.UIStoryboardSegue) -> Rswift.TypedStoryboardSegueInfo<UIKit.UIStoryboardSegue, AlbumListViewController, AdminPhotoCollectionViewController>? {
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct mainStoryboard: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let schiavo = StoryboardViewControllerResource<AdminPhotoCollectionViewController>(identifier: "Schiavo")
      
      func schiavo(_: Void = ()) -> AdminPhotoCollectionViewController? {
